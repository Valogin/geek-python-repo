...
клетки (целое число). В классе должны быть реализованы методы перегрузки арифметических операторов: сложение (add()),
...
class Cell:
    ...
    def __str__(self):
        return f' ячеек =  {self.quantity} {self.quantity * "*"}'
    ...
    def __sub__(self, other):
        ...
        return ' Результат отрицательный!' \
            if (self.quantity-other.quantity) <= 0 else Cell(self.quantity-other.quantity)
...
cells1 = Cell(22)
cells2 = Cell(15)
print(f"Число{cells1}")
print(f"Число{cells2}")
